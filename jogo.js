...
function acertou(obj) {
  ...
  img.src = "https://static.vecteezy.com/system/resources/previews/001/187/508/non_2x/heart-png.png";
...
function errou(obj) {
  ...
  img.id = "imagem1";
  //altera o atributo src (source) da imagem criada
  img.src = "https://static.vecteezy.com/system/resources/previews/018/719/301/non_2x/broken-heart-symbol-on-transparent-background-free-png.png";
  //adiciona a imagem criada na div (obj) escolhida pelo jogador (appendChild)
  obj.appendChild(img);
}
